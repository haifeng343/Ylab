  ...
  <div class="app-container">
    <ylab-hiddenable-container>
      <el-form label-position="left" :inline="true" class="ybr-form-row" style="width: calc(100% - 80px);">
        ...
        <!-- <el-form-item label="申请时间：">
          <el-date-picker v-model="createTime" type="daterange" format="yyyy-MM-dd" value-format="yyyy-MM-dd" clearable range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" />
        </el-form-item> -->
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          <el-button v-if="row.approveStatus === 1" v-permission="['getUseApprove','admin']" type="primary" @click="approveStore(row)">
            审批
          </el-button>
          <el-button v-if="row.approveStatus === 1" type="danger" @click="cancelPermit(row.id)">
            取消
          </el-button>
          <el-button v-if="row.approveStatus !== 1" v-permission="['getUseApprove','admin']" type="info" disabled>
            审批
          </el-button>
