<template>
  <div>
    <sticky v-if="!noSticky" :sticky-top="84" class-name="sub-navbar">
    ...
    <div class="app-container">
      ...
      <div class="container-standard">
        <el-form ref="otherForm" :inline="true" :model="editData" :rules="rules" class="ybr-form-row" label-position="left">
          <!-- <div>
            <el-form-item class="businessContract" label="归属实验:">
              <el-select v-model="editData.experimentId" filterable placeholder="请选择">
          ...
          <!-- <el-form-item v-if="buttonPermissions.includes(modifyTaskCurId) || !editData.curId" label="负责人:">
...
export default {
  ...
  computed: {
    ...
    // 修改任务负责人
    // modifyTaskCurId() {
    //   return this.buttonPermission[this.platform].taskCurId
    // }
  },
  created() {
    ...
    experimentFetchList({ pageNo: 1, pageSize: 100000 }).then(res => {
      this.experimentList = res.data.list
    })
  },
  methods: {
    handleSubmit() {
