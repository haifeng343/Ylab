    ...
    <el-row :gutter="32">
        ...
        <div class="chart-wrapper">
          ...
          <div class="chart">
            <div style="position:relative">
              <el-progress type="circle" :percentage="contracts.percent" :stroke-width="9" :width="135" color="#5370FF" />
      ...
      <el-col :xs="24" :sm="12" :lg="6">
        <div class="chart-wrapper">
          ...
          <div class="chart">
            <div style="position:relative">
              <el-progress type="circle" :percentage="tasks.percent" :stroke-width="9" :width="135" color="#5370FF" />
              <div class="alignCenter">
        ...
        <div class="chart-wrapper">
          ...
          <div class="chart2">
            ...
            <div style="margin-left: 30px;">
              ...
              <div class="legend">
                <span class="icon" style="background: #5370FF;" />
    ...
    <el-row :gutter="32">
      ...
      <el-col :xs="24" :sm="12" :lg="6">
        <div class="list-wrapper">
          ...
          <div v-if="approvingTotal === 0" class="tabel-item">
